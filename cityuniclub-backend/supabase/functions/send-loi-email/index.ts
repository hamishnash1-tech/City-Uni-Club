    ...
    const emailBody = `
      <html>
        <body style="font-family: Arial, sans-serif; font-size: 14px; color: #000; line-height: 1.6;">
          ...
          <p>Please find attached an introduction letter for ${escapeHtml(memberName)} who is a member of the City University Club and will be visiting your club ${escapeHtml(visitDates)}.</p>
